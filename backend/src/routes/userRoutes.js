...
const {createUser, getUser, updateUser, deleteUser, login, logout} = require('./../controllers/user.controller');
...
// Basic DB operations
router.post('/register', isLoggedIn, validateFields, createUser);
